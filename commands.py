...
main_buttons = [[
        InlineKeyboardButton('Main Channel', url='https://t.me/TBots_Father')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ', url='https://t.me/TBotsFatherSupport'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/TBots_Father')
        ],[
